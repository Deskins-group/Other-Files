...
- **BDM-polaron-vasp-python3.py** A script to create a polaronic distortion around a specified atomic site. Works with VASP POSCAR files and python 3. Usage is: "BDM-polaron-vasp-python3.py [filename] [perc increase] [atom number] [number nearest neighbors]".
